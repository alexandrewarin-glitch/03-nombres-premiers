...
5️⃣ Lorsque le score de test ``ST`` est satisfaisant, s'intéresser à la [qualité du code](https:py//perso.esiee.fr/~courivad/courses/utils/sources/python-23-codequality.html).
